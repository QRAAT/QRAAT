...
new devices when they're plugged in. For instance, when you installed the GNU Radio, rules were installed 
...
to the internet. The last thing we have to do is configure the network interface so that we can 
...
it's best to create an image from a fully configured system and copying this to other sites. The 
