...
class HelloChoice(models.Model):
    id = models.IntegerField(primary_key=True)
    poll = models.ForeignKey(HelloPoll)
    choice = models.CharField(max_length=600)
    votes = models.IntegerField()
    class Meta:
        db_table = u'hello_choice'

class HelloPoll(models.Model):
    id = models.IntegerField(primary_key=True)
    question = models.CharField(max_length=600)
    pub_date = models.DateTimeField()
    class Meta:
        db_table = u'hello_poll'

class HelloSite(models.Model):
    id = models.IntegerField(primary_key=True)
    class Meta:
        db_table = u'hello_site'
