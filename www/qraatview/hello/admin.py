...
from hello.models import sitelist, track, tx_ID, TxType, TxInfo, TxDeployment
...
class TxDeploymentAdmin(admin.ModelAdmin):
    list_display = ('ID', 'tx_ID', 'start_time',
                    'stop_time')
    ordering = ('ID',)
...
admin.site.register(TxDeployment, TxDeploymentAdmin)
